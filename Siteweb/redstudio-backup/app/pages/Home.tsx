    ...
    <div className="home">
      ...
      <section ref={heroRef} className="hero">
        <div className="hero-content">
          ...
          <button onClick={() => setCurrentPage?.("events")} className="cta-button">Explorez</button>
        </div>
      </section>
      ...
      <section id="events" className="events-section">
        <div className="section-container">
          ...
          <div className="view-all">
            <button onClick={() => setCurrentPage?.("events")} className="link-button">Voir tous les événements →</button>
          </div>
        </div>
      </section>
        ...
        <div className="section-container">
          ...
          <div className="view-all">
            <button onClick={() => {
              setCurrentPage?.("artists");
              window.scrollTo(0, 0);
            }} className="link-button">Voir plus d'artistes →</button>
          </div>
        </div>
      </section>
    </div>
